...
contract RaffleTest is Test {
    ...
    function testRaffleRevertWhenNotEnoughEthPaidToEnterRaffle() public {
        // Arrange
        vm.prank(PLAYER);
        // Act / Assert
    ...
    function testDontAllowEntryIfRaffleIsCalculating() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    function testFulfillRandomWordsPicksAWinnerResetsAndSendsMoney() public raffleEntered {
        ...
        VRFCoordinatorV2_5Mock(VRFCoordinatorV2_5Mock).fulfillRandomWords(uint256(requestId), address(raffle));
